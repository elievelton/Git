...
class Main(QMainWindow, Ui_Main):
    ...
    def abrirTelaDepositar(self):
        ...
        self.tela_depositar.lineEdit_4.setText(lista[0][1])
        self.tela_depositar.lineEdit_5.setText(str(convert_conta[0][0]))
        self.tela_depositar.lineEdit_3.setText('R$ ' + str(convert_conta[0][2]))
    ...
    def abrirTelaTransferir(self):
        ...
        conta = self.ban.Buscar_conta_bd(conexao,lista[0][6])
        convert_conta = list(conta)
        self.tela_transferir.lineEdit_6.setText(lista[0][1])
        self.tela_transferir.lineEdit_5.setText(str(convert_conta[0][0]))
        self.tela_transferir.lineEdit_4.setText('R$ ' + str(convert_conta[0][2]))
