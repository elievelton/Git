...
class Tela_Sacar(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(100, 220, 201, 20))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(100, 270, 211, 20))
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.pushButton.setGeometry(QtCore.QRect(250, 340, 106, 36))
        font = QtGui.QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(290, 220, 131, 21))
        self.lineEdit.setStyleSheet("background-color: rgb(255, 170, 0);")
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setGeometry(QtCore.QRect(290, 270, 131, 21))
        self.lineEdit_2.setStyleSheet("background-color: rgb(255, 170, 0);")
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(-10, 30, 741, 61))
        ...
        self.label_5.setGeometry(QtCore.QRect(290, 100, 191, 21))
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_6.setGeometry(QtCore.QRect(24, 143, 71, 16))
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(470, 97, 140, 30))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(90, 100, 111, 21))
...
"color: rgb(0, 0, 0);")
        ...
        self.lineEdit_5.setGeometry(QtCore.QRect(90, 140, 111, 21))
